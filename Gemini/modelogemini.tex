...
\begin{small}
\begin{verbatim}
// Laço de Verificação Lógica de Agendamentos Recebidos pelo App
boolean agendamentoCheck() {
  if (!getLocalTime(&timeinfo)) {
    Serial.println("Erro: Obtencao da data atual falhou"); return false;
  } else {
