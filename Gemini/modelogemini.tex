...
\begin{table}[ht]
    ...
    \hline
    \textbf{Solução / Trabalho} & \textbf{Peso Real?} & \textbf{Módulo Água?} & \textbf{Tecnologia} & \textbf{Custo Base} \\ \hline
    SureCare \cite{surecare:26}  & Sim                 & Não                   & Closed Source          & Alto    \\ \hline
