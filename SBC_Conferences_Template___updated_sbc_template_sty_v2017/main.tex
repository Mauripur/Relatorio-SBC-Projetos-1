...
\begin{abstract}
  ...
  This article describes the implications of creating an automatic feeder for domestic animals, such as dogs and cats, presenting the project's context, justification, and objective. *chatgpt insert text petty please*
  
\end{abstract}
     
\begin{resumo}

  Este artigo descreve as implicações da criação de um comedouro automático para animais de estimação, como cães e gatos, com apresentação do contexto, justificativa e objetivo do projeto. *chatgpt insira texto porfa*
